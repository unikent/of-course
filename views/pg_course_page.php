						...
						<table class="table">
						  ...
						  <tbody>
								...
								<tr>
							      ...
							      <td><?php echo empty($delivery->fees->home->{'full-time'}) ? ((empty($delivery->fees->home->{'euro-full-time'})) ? '-' : '&euro;' . $delivery->fees->home->{'euro-full-time'}) : '&pound;' . $delivery->fees->home->{'full-time'}; ?></td>
							      <td><?php echo empty($delivery->fees->int->{'full-time'}) ? ((empty($delivery->fees->int->{'euro-full-time'})) ? '-' : '&euro;' . $delivery->fees->int->{'euro-full-time'}) : '&pound;' . $delivery->fees->int->{'full-time'}; ?></td>
							    </tr>
							    <?php endif;?>
							    <?php if($has_parttime):?>
							    <tr>
							      <td><strong>Part-time</strong></td>
							      <td><?php echo empty($delivery->fees->home->{'part-time'}) ? ((empty($delivery->fees->home->{'euro-part-time'})) ? '-' : '&euro;' . $delivery->fees->home->{'euro-part-time'}) : '&pound;' . $delivery->fees->home->{'part-time'}; ?></td>
							      <td><?php echo empty($delivery->fees->int->{'part-time'}) ? ((empty($delivery->fees->int->{'euro-part-time'})) ? '-' : '&euro;' . $delivery->fees->int->{'euro-part-time'}) : '&pound;' . $delivery->fees->int->{'part-time'}; ?></td>
							    </tr>
							    <?php endif;?>
						  </tbody>
						</table>
