...
<?php if (isset($course->modules->stages->{"foundation"}) && $show_modules ): ?>
	<?php if (empty($course->foundation_year)): ?>
	<h3>Foundation year</h3>
	<?php endif; ?>
...
<?php if (isset($course->modules->stages->{1})  && $show_modules ): ?>
<section class="info-section">
	<h3>Stage 1</h3>
...
<?php if (isset($course->modules->stages->{2})  && $show_modules ): ?>
<section class="info-section">
	<h3>Stage 2</h3>
...
<?php if (! empty($course->year_in_industry)): ?>
	<section class="info-section">
		...
		<?php if (isset($course->modules->stages->{"S"})  && $show_modules ): ?>
			<?php if (empty($course->year_in_industry)): ?>
				<h3>Year in industry</h3>
			<?php endif; ?>
