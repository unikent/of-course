...
<?php if(empty($course->subject_to_approval)): ?>
	...
	<form id="ug_apply_form">
		...
		<p class="apply-link fulltime-link courses-sits-apply-hidden-ft"><strong>No matching courses</strong><br /><br />There are currently no courses matching your selection. Please make a different selection.</p>
		
		<p class="apply-link parttime-link courses-sits-apply-hidden-pt"><strong>No matching courses</strong><br /><br />There are currently no courses matching your selection. Please make a different selection.</p>
