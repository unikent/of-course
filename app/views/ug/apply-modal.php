...
<!-- Modal -->
<div class="modal modal-course fade" id="apply-modal" tabindex="-1" role="dialog" aria-labelledby="apply"
	 aria-hidden="true">
						...
						<div class="apply-form apply-form-ug">
							...
							<div>
								<fieldset class="highlight-fieldset indent">
									...
									<input type="hidden" id="award"
										   value="<?php echo strtolower(str_replace(array('/', ' ', '(', ')'), '', $course->award[0]->name)); ?>">
					...
					<div class="col-lg-4">
						...
						<?php foreach ($course->deliveries as $delivery) { ?>
							...
							<a
									...
									class="btn btn-large chevron-link btn-primary next-btn apply-link-courses"
						...
						<?php if (!empty($course->ucas_code)): ?><p class="ucas-code">UCAS

							code <?php echo $course->ucas_code ?></p><?php endif; ?>
