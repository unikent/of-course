				...
				<section class="panel tertiary-tier highlighted no-border kiss-widget-section">
					...
					<?php if ($has_fulltime){ ?>
						...
						<div class="col-xs-12 col-sm-6 col-lg-12">
							...
							<iframe id="unistats-widget-frame-ft" title="Unistats KIS Widget" src="//discoveruni.gov.uk/widget/<?php echo $ukprn ?>/<?php echo str_replace(array('/', '|', ':', '&', '.', '>', '+', '#', ';', '?', '@', '='), '_', $course->kiscourseid); ?>/horizontal/small/en-GB/FullTime" scrolling="no" style="overflow: hidden; border: 0px none transparent; width: 615px; height: 150px;"> </iframe>
						</div>
					<?php } ?>
					<?php if ($has_parttime){ ?>
						<div class="col-xs-12 col-sm-6 col-lg-12">
							...
							<?php } ?>
							<?php $ukprn = (isset($course->kis_institution_id) && $course->kis_institution_id != '') ? $course->kis_institution_id : $course->globals->ukprn; ?>
							<iframe id="unistats-widget-frame-pt" title="Unistats KIS Widget" src="//discoveruni.gov.uk/widget/<?php echo $ukprn ?>/<?php echo str_replace(array('/', '|', ':', '&', '.', '>', '+', '#', ';', '?', '@', '='), '_', $course->kiscourseid); ?>/horizontal/small/en-GB/PartTime" scrolling="no" style="overflow: hidden; border: 0px none transparent; width: 615px; height: 150px;"> </iframe>
						</div>
