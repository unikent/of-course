...
<ul class="nav nav-tabs-vertical" role="tablist">
    ...
    <?php if (strpos($course->programme_type, 'taught') !== false || (strpos($course->programme_type, 'research') !== false && !empty($course->programme_overview))): ?>
        <li class="nav-item"><a href="#structure" data-toggle="tab" role="tab" class="nav-link" onclick="window.KENT.kat.event('course-page', 'course-structure-pg', $course_name_fortracking)">Course structure</a></li>
    <?php endif; ?>
